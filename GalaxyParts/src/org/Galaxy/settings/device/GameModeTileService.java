...
public class GameModeTileService extends TileService {
    ...
    public void onClick() {
        ...
        Utils.writeValue(GalaxyParts.TP_LIMIT_ENABLE, enabled ? "1" : "0" );
        Utils.writeValue(GalaxyParts.TP_DIRECTION, enabled ? "0" : "1" );
        sharedPrefs.edit().putBoolean(GalaxyParts.KEY_GAME_SWITCH, enabled ? false : true).commit();
