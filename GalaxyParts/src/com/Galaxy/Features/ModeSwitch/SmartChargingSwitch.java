...
package com.Galaxy.Features.ModeSwitch;
...
import com.Galaxy.Features.GalaxyParts;
import com.Galaxy.Features.Utils;
...
public class SmartChargingSwitch implements OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        Intent SmartChargingSVC = new Intent(mContext, com.Galaxy.Features.SmartChargingService.class);
        if (enabled) {
